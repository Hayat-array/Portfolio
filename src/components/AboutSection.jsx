...
export function AboutSection() {
  return (
    ...
    <div  className="relative rounded-xl p-[2px] overflow-hidden group 
      ...
      <section className=" mr-2 ml-2 rounded-md align-center p-5 justify-center px-6 py-16 bg-white text-gray-800 animate-fade-up transition-all duration-700 ease-in-out">
